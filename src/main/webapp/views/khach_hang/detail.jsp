    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="ten" value="${detail.ten}" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="trangthai" value="${detail.tt == 1 ? 'Hoạt động' : 'Ngừng hoạt động'}" readonly>
            </div>
            <div class="text-end
">
