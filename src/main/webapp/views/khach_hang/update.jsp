...
<div class="container">
    ...
    <form action="/khach-hang/update/${khachHang.id}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" id="tenkh" name="ten" class="form-control" value="${khachHang.ten}">
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="trangthai" name="tt">
                <option value="1" ${khachHang.tt == 1 ? 'selected' : ''}>Hoạt động</option>
                <option value="0" ${khachHang.tt == 0 ? 'selected' : ''}>Ngừng hoạt động</option>
            </select>
        </div>
